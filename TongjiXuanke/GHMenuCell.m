...
//		bgView.backgroundColor = [UIColor colorWithRed:(47.0f/255.0f) green:(47.0f/255.0f) blue:(47.0f/255.0f) alpha:1.0f];
		...
		self.textLabel.font = [UIFont fontWithName:@"Helvetica" size:([UIFont systemFontSize] * 1.3f)];
...
//		topLine.backgroundColor = [UIColor colorWithRed:(35.0f/255.0f) green:(35.0f/255.0f) blue:(35.0f/255.0f) alpha:1.0f];
//		[self.textLabel.superview addSubview:topLine];
//		
//		UIView *topLine2 = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 1.0f, [UIScreen mainScreen].bounds.size.height, 1.0f)];
//		topLine2.backgroundColor = [UIColor colorWithRed:(54.0f/255.0f) green:(61.0f/255.0f) blue:(76.0f/255.0f) alpha:1.0f];
...
//		bottomLine.backgroundColor = [UIColor colorWithRed:(35.0f/255.0f) green:(35.0f/255.0f) blue:(35.0f/255.0f) alpha:1.0f];
